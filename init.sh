...
echo "Tips:"
echo ""
echo "  • The more you fill in your CLAUDE.md, the better the AI gets."
echo "    Start with Writing Style and Key Acronyms for the biggest impact."
echo ""
echo "  • Drop example docs into your workspace (PRDs, strategy docs, writing"
echo "    samples, status updates) and ask the AI to analyze them. It can extract"
echo "    your writing patterns, build out your Writing Style section, and create"
echo "    templates in 03_resources/templates/ based on your real work."
echo ""
echo "    Try: \"Here's a PRD I wrote — update my Writing Style section based"
echo "    on how I write\" or \"Create a PRD template from this example.\""
echo ""
